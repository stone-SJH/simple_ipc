 ...
 */
ASTCENC_PUBLIC astcenc_image* astc_img_from_floatx4_array(
	const float* data,
	unsigned int dim_x,
	unsigned int dim_y,
	bool y_flip);
 ...
 */
ASTCENC_PUBLIC int get_cpu_count();
 ...
 */
ASTCENC_PUBLIC void launch_threads(
 ...
 */
ASTCENC_PUBLIC void compression_workload_runner(
	int thread_count,
	int thread_id,
	void* payload
);
